    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text("Heya!! thank you for choosing me Sweetheart! Hey {}, I'm {}! Thank you for adding me to {}" 
                !".format(user.first_name, context.bot.first_name, chat_name))
