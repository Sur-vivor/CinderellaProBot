...
from alluka import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, LOGGER, MESSAGE_DUMP
from alluka.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text("Heya!! thank you for choosing me Sweetheart! Hey {}, I'm {}! Thank you for adding me to {}!".format(user.first_name, context.bot.first_name, chat_name))
