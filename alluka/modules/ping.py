...
def ping(bot: Bot, update: Update):
    ...
    allukaping = send_message(update.effective_message, "Pong!")


    reply_msg = "PONG!!\n<b>Time Taken:</b> <code>{}</code>" \
                "\n<b>Service uptime:</b> <code>{}</code>".format(telegram_ping, uptime)

    context.bot.editMessageText(chat_id=update.effective_chat.id, message_id=allukaping.message_id,
                        text=(update.effective_message,reply_msg),parse_mode=ParseMode.HTML)
