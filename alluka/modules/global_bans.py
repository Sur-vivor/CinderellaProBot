...
from alluka import dispatcher, OWNER_ID, SUDO_USERS, DEV_USERS, SUPPORT_USERS, WHITELIST_USERS, STRICT_GBAN, GBAN_LOGS, spam_watch
from alluka.modules.helper_funcs.chat_status import user_admin, is_user_admin, sudo_plus
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if GBAN_LOGS:
        ...
        send_to_list(
            ...
            SUDO_USERS +
            SUPPORT_USERS,
            "{} has been successfully gbanned!".format(mention_html(user_chat.id, user_chat.first_name)), html=True)
    ...
    try:
        bot.send_message(
            ...
            "If you think that this was a mistake, you may appeal your ban [here](tg://user?id={})".format(OWNER_ID),
            parse_mode=ParseMode.HTML)
...
def ungban(bot: Bot, update: Update, args: List[str]):
    ...
    if GBAN_LOGS:
        ...
        send_to_list(bot, SUDO_USERS + SUPPORT_USERS, "{} has been pardoned from gban!".format(mention_html(user_chat.id, 
                                                                         user_chat.first_name)), html=True)
    ...
    if ungban_time > 60:
        ...
        message.reply_text(
            "{} has been un-gbanned. Took {} min".format((mention_html(user_chat.id, user_chat.first_name)), ungban_time),
                        parse_mode=ParseMode.HTML)
    else:
        message.reply_text(
            "{} has been un-gbanned. Took {} sec".format((mention_html(user_chat.id, user_chat.first_name)), ungban_time),
                        parse_mode=ParseMode.HTML)
...
Cinderella also integrates @Spamwatch API into gbans to remove Spammers as much as possible from your chatroom!
*What is SpamWatch?*
...
Cinderella will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group.
...
__handlers__ = [GBAN_HANDLER, UNGBAN_HANDLER, GBAN_LIST, GBAN_STATUS, CHECK_GBAN_HANDLER, CLEAN_GBAN_HANDLER]
