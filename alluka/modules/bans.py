...
*Admin only:*
 ...
 - /roar : Self Unban (Only for admins)
"""
...
__mod_name__ = "Bans"
__handlers__ = [BAN_HANDLER, TEMPBAN_HANDLER, KICK_HANDLER, UNBAN_HANDLER, ROAR_HANDLER, KICKME_HANDLER, BANME_HANDLER, SBAN_HANDLER]
