...
if START_IMG is None:
    img = "https://telegra.ph/file/dcce4a21fcab47cea0333.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="⚡️Creator⚡️",url="https://t.me/Saravanakrish")]]
